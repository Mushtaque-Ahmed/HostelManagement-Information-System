...
<body>
  ...
  <section class="home-section">
    <div class="text"> Student fee Details</div>
        ...
        ?>
            <tr>
              ...
              <td><?php
                  ...
                  if ($row['status'] == 1) {
                    echo '<span "><a class="text-info"href="?type=status&operation=unpaid&id=' . $row['s_id'] . '"><b>paid</b></a>
            </span>';
                  } else {
                    echo '<span ><a class="text-danger" href="?type=status&operation=paid&id=' . $row['s_id'] . '"><b>unpaid</b></a>
              <span>';
                  } ?>
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      if ($page > 1) {
        echo '<li class="page-item"><a class="page-link" href="fee_details.php?page=' . ($page - 1) . '">previous</a></li>';
      }
      for ($i = 1; $i <= $total_page; $i++) {
        ...
        echo '<li class="page-item ' . $active . '"><a class="page-link" href="fee_details.php?page=' . $i . '">' . $i . '</a></li>';
      }
      if ($total_page > $page) {
        echo '<li class="page-item"><a class="page-link" href="fee_details.php?page=' . ($page + 1) . '">next</a></li>';
      }
      echo '</ul>';
    }
    ?>
