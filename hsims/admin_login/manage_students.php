...
<body>
  ...
  <section class="home-section">
    <div class="text">Manage Student Details</div>
      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td>
                <button><a href="?type=update&id=<?php echo $row['s_id']?>">Update</a></button>
    ...
    <?php
						...
						if(mysqli_num_rows($res)>0){
							...
							$total_page=ceil($total_record/$limit);
							 ...
							 if($page>1){
								  echo'<li class="page-item"><a class="page-link" href="manage_students.php?page='.($page - 1).'">previous</a></li>';
							  }
							for($i=1; $i<=$total_page; $i++){
								if($i==$page){
								  ...
								  echo'<li class="page-item '.$active.'"><a class="page-link" href="manage_students.php?page='.$i.'">'.$i.'</a></li>';
							}
							 if($total_page > $page){
								  echo'<li class="page-item"><a class="page-link" href="manage_students.php?page='.($page + 1).'">next</a></li>';
							  }
							echo '</ul>';
						}
						?>
