...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'delete') {
        ...
        $delete = "delete from student_proof where id='$id'";
        ...
        <table class="table table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col">Check money receipt</th>
            ...
            <?php
                ...
                ON student_proof.id = student.s_id";
                ...
                <tr>
                    ...
                    <td><p></p><a class="btn btn-danger" href="see_money_receipt.php?id=<?php echo $row['id'] ?>"> Check Money receipt</a></td>
